...
type ServerInterface interface {
	...
	CreateTransaction(w http.ResponseWriter, r *http.Request, userId string)

	// (GET /users/{userId}/transactions/summary)
	GetTransactions(w http.ResponseWriter, r *http.Request, userId string)
}
...
func (siw *ServerInterfaceWrapper) CreateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateTransaction(w, r, userId)
	})
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/users/{userId}/transactions", wrapper.CreateTransaction)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/users/{userId}/transactions/summary", wrapper.GetTransactions)
	})
